...
export default function Hero() {
  const words = [
    ...
    "Student of Agnetic Ai"
  ];

  const [code] = useState(`
const profile = {
    name: 'Usama Ayoub',
    title: 'Full-Stack Developer | Ai Enthusiast | Backend Developer',
    skills: [
       'Javascript','Node js','Node js','React js',
       'Next js','Python','Django','Flask','Streamlit',
       'Tailwind css','Shad Cn','Chakra ui','Material ui',
       'Git','Github'
    ],
    hardWorker: true,
    quickLearner: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | Ai Enthusiast 🤖| Crafting frameworks
